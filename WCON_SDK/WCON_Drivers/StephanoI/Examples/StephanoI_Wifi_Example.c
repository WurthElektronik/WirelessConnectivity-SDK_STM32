...
#include <StephanoI/Examples/StephanoI_Wifi_Example.h>
 ...
 */
StephanoI_ATWiFi_State_t StephanoI_Examples_Wifi_State = {
		.state = StephanoI_ATWifiState_NotConnected };
...
void StephanoI_Wifi_Examples_EventCallback(char *eventText)
{
	...
	case StephanoI_ATEvent_Socket_GetMultiple:
	{
		if (StephanoI_ATSocket_ParseGetMultiple(eventText, &multiple_sockets_enabled))
		{
			...
			{
				printf("Multiple sockets enabled\r\n");
			}
			else
			{
				printf("Multiple sockets disabled\r\n");
			}
		}
	}
		break;
	case StephanoI_ATEvent_Socket_Receive:
	{
		...
		{
			printf("Socket received event received: 0x");
	...
	case StephanoI_ATEvent_Socket_Ping:
	{
		...
		{
			printf("Socket ping event received.\r\n"
					"Time: %lu ms\r\n", (uint32_t) ping);
		}
	}
		break;
	case StephanoI_ATEvent_Socket_DomainResolved:
	{
		...
		{
			printf("Socket domain resolved event received.\r\n"
					"IP: %s\r\n", domain);
		}
	}
		break;
	case StephanoI_ATEvent_Wifi_State:
	{
		...
		{
			printf("Wifi state event received.\r\n"
					"State: %d\r\n"
	...
	case StephanoI_ATEvent_Wifi_Scan:
	{
		...
		{
			printf("Wifi scan event received.\r\n"
					"SSID: %s\r\n"
					"Encryption: %d\r\n"
					"RSSI: %d\r\n"
	...
	case StephanoI_ATEvent_Wifi_GetAPIP:
	{
		...
		{
			printf("Wifi getIP event received.\r\n"
					"IP: %s\r\n"
					"Gateway: %s\r\n"
	...
	case StephanoI_ATEvent_Wifi_GetConnectedIPs:
	{
		...
		{
			printf("Wifi connected IPs event received.\r\n"
					"MAC: %s\r\n"
					"IP: %s\r\n", t.MAC, t.IP);
		}
	}
	...
	case StephanoI_ATEvent_Wifi_StationhasConnected:
	{
		...
		{
			printf("Wifi station has connected event received.\r\n"
					"MAC: %s\r\n", t);
		}
	}
		break;
	case StephanoI_ATEvent_Wifi_APAssignIP:
	{
		...
		{
			printf("Wifi AP assign IP event received.\r\n"
					"MAC: %s\r\n"
					"IP: %s\r\n", t.MAC, t.ip);
		}
	}
	...
	case StephanoI_ATEvent_Webserver_Response:
	{
		...
		{
			printf("Webserver response event received.\r\n"
...
{
	printf("*** Start of StephanoI Wifi station example ***\r\n");
	...
	StephanoI_ATWifiCountryCode_t countrycode = {
			.policy = StephanoI_ATWifiCountryCodePolicy_Keep,
			.country_code = "DE",
			.start_channel = StephanoI_ATWifiChannel_1,
			.total_channel_count = 13 };
...
{
	printf("*** Start of StephanoI Wifi AP example ***\r\n");
	...
	StephanoI_ATWiFi_APConfiguration_t ap_config = {
			.ssid = "myAP",
			.pwd = "myPassword",
			.channel = StephanoI_ATWifiChannel_8,
			.ecn = StephanoI_ATWifiEncryptionMethod_WPA2PSK,
			.max_connections = 10,
			.ssid_hidden = false };
...
{
	printf("*** Start of StephanoI MQTT example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
...
{
	printf("*** Start of StephanoI HTTP example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
...
{
	printf("*** Start of StephanoI TCP client example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
...
{
	printf("*** Start of StephanoI TCP throughput transmission example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
	char tcp_remote_host[WIFI_SSID_STRINGLEN] = "192.168.178.20";
	uint16_t tcp_remote_port = 8080;
...
{
	printf("*** Start of StephanoI provisioning example ***\r\n");
	...
	StephanoI_ATWiFi_APConfiguration_t APconfig = {
			.ssid = "Provision me",
			.pwd = "",
			.channel = StephanoI_ATWifiChannel_11,
			.ecn = StephanoI_ATWifiEncryptionMethod_Open,
			.max_connections = 5,
			.ssid_hidden = false };
...
{
	printf("*** Start of StephanoI OTA example ***\r\n");
	...
	{
		printf("Waiting to finish OTA, state: %d\r\n", StephanoI_Examples_Webserver_State);
		WE_Delay(10000);
	}
...
{
	printf("*** Start of StephanoI TCP server example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
...
{
	printf("*** Start of StephanoI UDP client example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
...
{
	printf("*** Start of StephanoI UDP throughput example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
	char udp_remote_host[WIFI_SSID_STRINGLEN] = "192.168.178.20";
	uint16_t udp_remote_port = 8080;
...
{
	printf("*** Start of StephanoI SSL server example ***\r\n");
	char target_network_ssid[WIFI_SSID_STRINGLEN] = "FRITZ!Box LTE";
	char target_network_password[WIFI_PWD_STRINGLEN] = "2314-5467-3428";
	uint16_t tcp_host_port = 5678;
	...
	StephanoI_ATSocket_SSLClientName_t name = {
			.link_ID = 0,
			.common_name = "Link0" };
