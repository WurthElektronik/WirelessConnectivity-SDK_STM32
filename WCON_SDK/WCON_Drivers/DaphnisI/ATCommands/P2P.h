...
/**
 * @file
 * @brief P2P commands for DaphnisI header file.
 */
...
/**
 * @brief Parse the value of TX time event (@ref DaphnisI_ATEvent_P2P_TxTime)
 *
...
/**
 * @brief Parse the value of RX data event (@ref DaphnisI_ATEvent_P2P_RxData)
 *
 * @param[in,out] pEventArguments: String containing arguments of the AT command.
 *
 * @param[out] rxDataP: Pointer to received data struct.
 *
 * @return True if successful, false otherwise
 */
