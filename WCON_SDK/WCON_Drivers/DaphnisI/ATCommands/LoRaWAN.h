...
/** 
 * @brief LoRaWAN EUI length in bytes
*/
#define DAPHNISI_LORAWAN_EUI_LENGTH 8
/** 
 * @brief LoRaWAN key length in bytes
*/
...
typedef enum
{
    DaphnisI_DeviceClass_A = 0, /**< Class A */
    DaphnisI_DeviceClass_B,     /**< Class B */
    DaphnisI_DeviceClass_C,     /**< Class C */
    /** @cond DOXYGEN_IGNORE */
...
typedef enum
{
    DaphnisI_JoinMode_ABP,  /**< Activation by personalization */
    DaphnisI_JoinMode_OTAA, /**< Over the air activation */
    /** @cond DOXYGEN_IGNORE */
...
/** 
 * @brief LoRaWAN key type
*/
typedef enum
{
    DaphnisI_KeyType_APP,             /**< AppKey */
    DaphnisI_KeyType_NETWORK_SESSION, /**< NwkSKey */
    DaphnisI_KeyType_APP_SESSION,     /**< AppSKey */
    /** @cond DOXYGEN_IGNORE */
    /** @cond DOXYGEN_IGNORE */
...
/** 
 * @brief LoRaWAN delay type
*/
typedef enum
{
    DaphnisI_Delay_JoinWindow1, /**< Join Window 1 delay */
    DaphnisI_Delay_JoinWindow2, /**< Join Window 2 delay */
    DaphnisI_Delay_RX1,         /**< Receive Window 1 delay */
    DaphnisI_Delay_RX2,         /**< Receive Window 2 delay */
    /** @cond DOXYGEN_IGNORE */
    /** @cond DOXYGEN_IGNORE */
...
/** 
 * @brief LoRaWAN slot window
*/
typedef enum DaphnisI_SlotWindow_t
{
    DaphnisI_SlotWindow_1, /**< Receive Window 1 */
    DaphnisI_SlotWindow_2, /**< Receive Window 2 */
    DaphnisI_SlotWindow_P, /**< Ping Window */
    DaphnisI_SlotWindow_C, /**< C Window */
 ...
 *
 * @param[in] app_eui: APP_EUI (LSB First).
 *
 ...
 *
 * @param[out] app_euiP: Pointer to APP_EUI (LSB First).
 *
 * @return True if successful, false otherwise
 */
 ...
 *
 * @param[in] device_eui: DEUI (LSB First).
 *
 * @return True if successful, false otherwise
 */
 ...
 *
 * @param[out] device_euiP: Pointer to DEUI (LSB First).
 *
 * @return True if successful, false otherwise
 */
 ...
 *
 * @param[in] keyType: Type of key to set.
 *
 * @param[in] key: Key (LSB First).
 *
 * @return True if successful, false otherwise
 */
 ...
 *
 * @param[in] device_address: Device address (LSB First).
 *
 * @return True if successful, false otherwise
 */
 ...
 *
 * @param[out] device_addressP: Pointer to device address (LSB First).
 *
 * @return True if successful, false otherwise
 */
 ...
 * @brief Set delay
 *
 * @param[in] delayType: which delay to set.
 *
 ...
 * @return True if successful, false otherwise
 */
extern bool DaphnisI_LoRaWAN_GetRegionalParametersVersion(DaphnisI_LoRaWAN_RP_Version_t* rp_VersionP);
#endif

/*     LoRaWAN Events Parsers */

/**
 * @brief Parses the values of the class change event arguments (@ref DaphnisI_ATEvent_LoRaWAN_Class).
 *
...
/**
 * @brief Parses the values of the rx info event arguments (@ref DaphnisI_ATEvent_LoRaWAN_RxInfo).
 *
 * @param[in,out] pEventArguments: String containing arguments of the AT command
...
/**
 * @brief Parses the values of the rx data event arguments (@ref DaphnisI_ATEvent_LoRaWAN_RxData).
 *
 * @param[in,out] pEventArguments: String containing arguments of the AT command
...
/**
 * @brief Parses the values of the ping event arguments (@ref DaphnisI_ATEvent_LoRaWAN_BeaconInfo).
 *
 * @param[in,out] pEventArguments: String containing arguments of the AT command
