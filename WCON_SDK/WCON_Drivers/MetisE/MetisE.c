...
static MetisE_CMD_Frame_t txPacket = {
		.Stx = CMD_STX,
 ...
 *         false otherwise
 */
bool MetisE_GetDefault(MetisE_UserSettings_t us, uint8_t *response, uint8_t *response_length)
{
	return MetisE_GetSetting(us, true, response, response_length);
}
...
bool MetisE_SetDefault(MetisE_UserSettings_t us, uint8_t *value, uint8_t length)
{
	return MetisE_SetSetting(us, true, value, length);
}
