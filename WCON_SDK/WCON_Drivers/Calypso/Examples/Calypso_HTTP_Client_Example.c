...
void Calypso_HTTP_Client_Example(void)
{
	...
	if (secure)
	{
		...
		false, strlen(serverRootCert), serverRootCert, &bytesWritten);
	...
	ret = Calypso_ATHTTP_Connect(clientHandle, hostWithPrefix, Calypso_ATHTTP_ConnectFlags_IgnoreProxy,
	NULL,
	NULL, secure ? serverRootCertFile : "");
