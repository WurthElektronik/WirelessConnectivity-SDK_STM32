...
typedef enum ATMQTT_CreateFlags_t
{
    ...
    ATMQTT_CreateFlags_URL                  = (1 << 2),     /**< Server address is an URL and not an IP address */
    ATMQTT_CreateFlags_Secure               = (1 << 3),     /**< Secure connection */
    ATMQTT_CreateFlags_SkipDomainVerify     = (1 << 4),     /**< Skip domain verify */
    ATMQTT_CreateFlags_SkipCertVerify       = (1 << 5),     /**< Skip certificate verify */
    ATMQTT_CreateFlags_SkipDateVerify       = (1 << 6),     /**< Skip date verify */
    ATMQTT_CreateFlags_NumberOfValues       =  7            /**< Number of flags in this enumeration */
...
extern bool ATMQTT_Create(char *clientID,
                          uint32_t flags,
...
extern bool ATMQTT_Publish(uint8_t index,
                           char *topic,
                           ATMQTT_QoS_t QoS,
                           uint8_t retain,
                           uint16_t messageLength,
                           char *pMessage);
extern bool ATMQTT_Subscribe(uint8_t index,
                             uint8_t numOfTopics,
                             ATMQTT_SubscribeTopic_t *pTopics);
extern bool ATMQTT_Unsubscribe(uint8_t index,
                               char *topic1,
                               char *topic2,
                               char *topic3,
                               char *topic4);
extern bool ATMQTT_Set(uint8_t index,
