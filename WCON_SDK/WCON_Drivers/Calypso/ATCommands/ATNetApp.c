...
static const char *Calypso_ATNetApp_ApplicationStrings[Calypso_ATNetApp_Application_NumberOfValues] = {
		"HTTP_SERVER",
		"DHCP_SERVER",
		"MDNS",
		"DNS_SERVER",
...
static const char *Calypso_ATNetApp_HttpOptionStrings[Calypso_ATNetApp_HttpOption_NumberOfValues] = {
		"PRIM_PORT_NUM",
		"AUTH_CHECK",
		"AUTH_NAME",
		"AUTH_PASSWORD",
...
static const char *Calypso_ATNetApp_DhcpOptionStrings[Calypso_ATNetApp_DhcpOption_NumberOfValues] = {
		"BASIC" };

static const char *Calypso_ATNetApp_mDnsOptionStrings[Calypso_ATNetApp_mDnsOption_NumberOfValues] = {
		"CONT_QUERY",
		"QEVETN_MASK",
		"TIMING_PARAMS" };

static const char *Calypso_ATNetApp_mDnsEventMaskStrings[Calypso_ATNetApp_mDnsEventMask_NumberOfValues] = {
		"ipp",
		"deviceinfo",
		"http",
		"https",
...
static const char *Calypso_ATNetApp_SntpOptionStrings[Calypso_ATNetApp_SntpOption_NumberOfValues] = {
		"enable",
		"update_interval",
		"time_zone",
		"server_address" };

static const char *Calypso_ATNetApp_DnsClientOptionStrings[Calypso_ATNetApp_DnsClientOption_NumberOfValues] = {
		"TIME" };

static const char *Calypso_ATNetApp_DeviceOptionStrings[Calypso_ATNetApp_DeviceOption_NumberOfValues] = {
		"URN",
		"DOMAIN" };
...
bool Calypso_ATNetApp_Set(Calypso_ATNetApp_Application_t app, uint8_t option, Calypso_ATNetApp_OptionValue_t *value)
{
	...
	case Calypso_ATNetApp_Application_mDns:
		...
		case Calypso_ATNetApp_mDnsOption_QeventMask:
			if (!ATCommand_AppendArgumentBitmask(pRequestCommand, Calypso_ATNetApp_mDnsEventMaskStrings, Calypso_ATNetApp_mDnsEventMask_NumberOfValues, value->mDns.qeventMask,
...
bool Calypso_ATNetApp_Get(Calypso_ATNetApp_Application_t app, uint8_t option, Calypso_ATNetApp_OptionValue_t *value)
{
	...
	case Calypso_ATNetApp_Application_mDns:
		...
		case Calypso_ATNetApp_mDnsOption_QeventMask:
			if (!ATCommand_GetNextArgumentBitmask(&pRespondCommand, Calypso_ATNetApp_mDnsEventMaskStrings, Calypso_ATNetApp_mDnsEventMask_NumberOfValues, 200, &value->mDns.qeventMask,
			ATCOMMAND_STRING_TERMINATE))
			{
				return false;
			}
...
{
	if (!ATCommand_AppendArgumentBitmask(pOutString, Calypso_ATNetApp_ApplicationStrings, Calypso_ATNetApp_Application_NumberOfValues, apps,
	ATCOMMAND_STRING_TERMINATE,
	AT_MAX_COMMAND_BUFFER_SIZE))
	{
		return false;
