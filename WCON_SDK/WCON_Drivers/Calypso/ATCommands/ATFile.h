...
extern bool Calypso_ATFile_Read(uint32_t fileID, uint16_t offset, Calypso_DataFormat_t format,
bool decodeBase64, uint16_t bytesToRead, char *data, uint16_t *bytesRead);
extern bool Calypso_ATFile_Write(uint32_t fileID, uint16_t offset, Calypso_DataFormat_t format,
