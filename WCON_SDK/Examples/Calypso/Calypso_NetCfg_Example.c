...
{
    WE_APP_PRINT("*** Start of Calypso ATNetCfg example ***\r\n");
    ...
    if (ret)
    {
        WE_APP_PRINT("MAC address: %02X-%02X-%02X-%02X-%02X-%02X\r\n", macAddress[0], macAddress[1], macAddress[2], macAddress[3], macAddress[4], macAddress[5]);
    }
    ...
    if (ret)
    {
        WE_APP_PRINT("*** Access point IPv4 configuration ***\r\n");
        WE_APP_PRINT("IPv4 address: %s\r\n", ipV4Config.ipAddress);
        WE_APP_PRINT("Subnet mask: %s\r\n", ipV4Config.subnetMask);
        WE_APP_PRINT("Gateway address: %s\r\n", ipV4Config.gatewayAddress);
        WE_APP_PRINT("DNS address: %s\r\n", ipV4Config.dnsAddress);
    ...
    if (ret)
    {
        WE_APP_PRINT("*** Local IPv6 configuration ***\r\n");
        WE_APP_PRINT("IPv6 address: %s\r\n", ipV6Config.ipAddress);
    }
    ...
    if (ret)
    {
        WE_APP_PRINT("*** Global IPv6 configuration ***\r\n");
        WE_APP_PRINT("IPv6 address: %s\r\n", ipV6Config.ipAddress);
    }
    ...
    if (ret)
    {
        WE_APP_PRINT("DNS second server address: %s\r\n", dns2ndServerAddress);
    }
