 ...
 */
static Calypso_ATEvent_SocketTCPAccept_t p2pServerAcceptEvent = {0};
 ...
 */
static Calypso_ATEvent_SocketTCPConnect_t p2pClientConnectEvent = {0};
                ...
                if (peerTcpConnected)
                {
                    ...
                    else
                    {
                        ...
                        if (len > 0)
                        {
                            ...
                            Calypso_ATSocket_Send(tcpServerClientSocketID, Calypso_DataFormat_Binary, false, len, p2pExampleReceiveBuffer, &bytesSent);
                        }
                    }
                }
